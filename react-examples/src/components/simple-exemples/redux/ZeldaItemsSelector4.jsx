...
class ZeldaItemSelector extends React.PureComponent {
  ...
  render () {
    ...
    return <div>
      <h1>Zelda items selector 4</h1>
      <div className="zeldaItemSelector">
        <div className="zeldaItems">
          {items.map(item => {
            return <ZeldaItem item={item} selectItem={this.props.selectItem}/>
          })}
        </div>
...
const mapStateToProps = (state) => {
  return {
    ...
    selectedItem : Selectors.getSelectedItem2(state)
  }
}
...
const mapDispatchToProps1 = (dispatch) => {
  return {
    selectItem: (id) => dispatch(ActionCreators.selectItem(id))
  }
}
...
const ZeldaItemSelectorConnected = connect(mapStateToProps, mapDispatchToProps1)(ZeldaItemSelector)
